...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class AdviserDetailClient
    {
        ...
        public AdviserDetailClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetAdviserDetailAsync(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("AdviserDetailClient.GetAdviserDetail");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetAdviserDetailRequest(id, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetAdviserDetail(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("AdviserDetailClient.GetAdviserDetail");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetAdviserDetailRequest(int id, RequestContext context)
        {
