...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class ContactClient
    {
        ...
        public ContactClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ContactClient.Post");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ContactClient.Patch");
            scope.Start();
            try
            {
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetContactAsync(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ContactClient.GetContact");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetContactRequest(id, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// 
        /// </remarks>
        public virtual Response GetContact(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ContactClient.GetContact");
            scope.Start();
            try
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ContactClient.Delete");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetContactRequest(int id, RequestContext context)
        {
