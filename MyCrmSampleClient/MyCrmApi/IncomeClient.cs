...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class IncomeClient
    {
        ...
        public IncomeClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetIncomeAsync(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeClient.GetIncome");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetIncomeRequest(id, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetIncome(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeClient.GetIncome");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetIncomeRequest(int id, RequestContext context)
        {
