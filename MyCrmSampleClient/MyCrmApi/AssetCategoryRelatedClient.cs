...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class AssetCategoryRelatedClient
    {
        ...
        internal AssetCategoryRelatedRestClient RestClient { get; }
        ...
        internal AssetCategoryRelatedClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null)
        {
            RestClient = new AssetCategoryRelatedRestClient(clientDiagnostics, pipeline, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AssetCategoryRelatedClient.Get");
            scope.Start();
            try
            {
