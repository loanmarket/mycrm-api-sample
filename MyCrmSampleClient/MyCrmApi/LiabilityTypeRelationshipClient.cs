...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class LiabilityTypeRelationshipClient
    {
        ...
        public LiabilityTypeRelationshipClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("LiabilityTypeRelationshipClient.GetLiabilityCategories");
            scope.Start();
            try
            {
