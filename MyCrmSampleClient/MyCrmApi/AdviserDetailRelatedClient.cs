...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class AdviserDetailRelatedClient
    {
        ...
        public AdviserDetailRelatedClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("AdviserDetailRelatedClient.GetAdvisers");
            scope.Start();
            try
            {
