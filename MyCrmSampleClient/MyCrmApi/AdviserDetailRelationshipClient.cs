...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class AdviserDetailRelationshipClient
    {
        ...
        public AdviserDetailRelationshipClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("AdviserDetailRelationshipClient.GetAdvisers");
            scope.Start();
            try
            {
