...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class DealNoteRelatedClient
    {
        ...
        public DealNoteRelatedClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("DealNoteRelatedClient.GetDeals");
            scope.Start();
            try
            {
