...
namespace MyCrmSampleClient.MyCrmApi
{
    internal partial class ContactGroupRelationshipRestClient
    {
        ...
        /// <param name="id"> The Integer to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<RelationshipsSingleDocument>> GetReferrerMembersAsync(int id, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="id"> The Integer to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<RelationshipsSingleDocument> GetReferrerMembers(int id, CancellationToken cancellationToken = default)
        {
            using var message = CreateGetReferrerMembersRequest(id);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
