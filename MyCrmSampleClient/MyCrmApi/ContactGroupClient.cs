...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class ContactGroupClient
    {
        ...
        public ContactGroupClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ContactGroupClient.Post");
            scope.Start();
            try
            {
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetContactGroupAsync(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ContactGroupClient.GetContactGroup");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetContactGroupRequest(id, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// 
        /// </remarks>
        public virtual Response GetContactGroup(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ContactGroupClient.GetContactGroup");
            scope.Start();
            try
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ContactGroupClient.Patch");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ContactGroupClient.Delete");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetContactGroupRequest(int id, RequestContext context)
        {
