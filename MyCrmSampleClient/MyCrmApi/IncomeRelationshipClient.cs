...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class IncomeRelationshipClient
    {
        ...
        public IncomeRelationshipClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeRelationshipClient.GetAssets");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeRelationshipClient.GetOwners");
            scope.Start();
            try
            {
