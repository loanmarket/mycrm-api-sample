...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class ExpenseTypeRelatedClient
    {
        ...
        public ExpenseTypeRelatedClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ExpenseTypeRelatedClient.GetExpenseCategories");
            scope.Start();
            try
            {
