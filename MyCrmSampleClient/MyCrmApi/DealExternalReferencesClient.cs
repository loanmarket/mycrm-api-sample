...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class DealExternalReferencesClient
    {
        ...
        public DealExternalReferencesClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// <summary> Gets a collection of external references of deals. </summary>
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetDealExternalReferenceAsync(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("DealExternalReferencesClient.GetDealExternalReference");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetDealExternalReferenceRequest(filter, sort, page, include, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetDealExternalReference(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("DealExternalReferencesClient.GetDealExternalReference");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetDealExternalReferenceRequest(IEnumerable<string> filter, IEnumerable<string> sort, object page, IEnumerable<string> include, RequestContext context)
        {
