...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class ExpensesClient
    {
        ...
        public ExpensesClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetExpenseAsync(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ExpensesClient.GetExpense");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetExpenseRequest(filter, sort, page, include, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetExpense(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ExpensesClient.GetExpense");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetExpenseRequest(IEnumerable<string> filter, IEnumerable<string> sort, object page, IEnumerable<string> include, RequestContext context)
        {
