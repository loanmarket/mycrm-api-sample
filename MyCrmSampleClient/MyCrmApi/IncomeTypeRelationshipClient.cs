...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class IncomeTypeRelationshipClient
    {
        ...
        public IncomeTypeRelationshipClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeTypeRelationshipClient.GetIncomeCategories");
            scope.Start();
            try
            {
