...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class ExpenseRelationshipClient
    {
        ...
        public ExpenseRelationshipClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ExpenseRelationshipClient.GetOwners");
            scope.Start();
            try
            {
