...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class IncomeCategoryClient
    {
        ...
        public IncomeCategoryClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetIncomeCategoryAsync(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeCategoryClient.GetIncomeCategory");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetIncomeCategoryRequest(id, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetIncomeCategory(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeCategoryClient.GetIncomeCategory");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetIncomeCategoryRequest(int id, RequestContext context)
        {
