...
{
    internal partial class IntegrationRestClient
    {
        ...
        /// <summary> Initializes a new instance of IntegrationRestClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> server parameter. </param>
        public IntegrationRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null)
        {
        ...
        internal HttpMessage CreatePostRequest(IntegrationDocument body)
        {
        ...
        public async Task<ResponseWithHeaders<IntegrationDocument, IntegrationPostHeaders>> PostAsync(IntegrationDocument body = null, CancellationToken cancellationToken = default)
        {
            ...
            var headers = new IntegrationPostHeaders(message.Response);
            switch (message.Response.Status)
            {
                case 201:
                    {
                        IntegrationDocument value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = IntegrationDocument.DeserializeIntegrationDocument(document.RootElement);
                        return ResponseWithHeaders.FromValue(value, headers, message.Response);
                    }
                case 401:
                    return ResponseWithHeaders.FromValue((IntegrationDocument)null, headers, message.Response);
                default:
        ...
        public async Task<Response<IntegrationDocument>> GetAsync(int id, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                ...
                case 401:
                    return Response.FromValue((IntegrationDocument)null, message.Response);
                default:
                    throw await ClientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
            }
        }
        ...
        internal HttpMessage CreatePatchRequest(int id, IntegrationDocument body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="body"> The IntegrationDocument to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<IntegrationDocument>> PatchAsync(int id, IntegrationDocument body = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="body"> The IntegrationDocument to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<IntegrationDocument> Patch(int id, IntegrationDocument body = null, CancellationToken cancellationToken = default)
        {
            using var message = CreatePatchRequest(id, body);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
