...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class PropertyTypeRelationshipClient
    {
        ...
        public PropertyTypeRelationshipClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetPropertyTypeRelationshipAsync(int id, string relationshipName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(relationshipName, nameof(relationshipName));

            using var scope = ClientDiagnostics.CreateScope("PropertyTypeRelationshipClient.GetPropertyTypeRelationship");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetPropertyTypeRelationshipRequest(id, relationshipName, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetPropertyTypeRelationship(int id, string relationshipName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(relationshipName, nameof(relationshipName));
        ...
        internal HttpMessage CreateGetPropertyTypeRelationshipRequest(int id, string relationshipName, RequestContext context)
        {
