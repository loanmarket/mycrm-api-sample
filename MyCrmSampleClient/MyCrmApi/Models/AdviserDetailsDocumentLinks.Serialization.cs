...
{
    public partial class AdviserDetailsDocumentLinks
    {
        internal static AdviserDetailsDocumentLinks DeserializeAdviserDetailsDocumentLinks(JsonElement element)
        {
            ...
            return new AdviserDetailsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
