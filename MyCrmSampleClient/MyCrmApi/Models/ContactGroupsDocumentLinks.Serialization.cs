...
{
    public partial class ContactGroupsDocumentLinks
    {
        internal static ContactGroupsDocumentLinks DeserializeContactGroupsDocumentLinks(JsonElement element)
        {
            ...
            return new ContactGroupsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
