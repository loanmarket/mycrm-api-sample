...
{
    public partial class DealImportantDateDocumentLinks
    {
        internal static DealImportantDateDocumentLinks DeserializeDealImportantDateDocumentLinks(JsonElement element)
        {
            ...
            return new DealImportantDateDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
