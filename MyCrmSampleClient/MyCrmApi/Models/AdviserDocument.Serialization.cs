...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static AdviserDocument DeserializeAdviserDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<AdviserDocumentLinks> links = default;
            Adviser data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = AdviserDocumentLinks.DeserializeAdviserDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Adviser.DeserializeAdviser(property.Value);
                    continue;
                }
            ...
            return new AdviserDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
