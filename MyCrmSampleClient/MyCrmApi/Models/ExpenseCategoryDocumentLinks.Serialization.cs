...
{
    public partial class ExpenseCategoryDocumentLinks
    {
        internal static ExpenseCategoryDocumentLinks DeserializeExpenseCategoryDocumentLinks(JsonElement element)
        {
            ...
            return new ExpenseCategoryDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
