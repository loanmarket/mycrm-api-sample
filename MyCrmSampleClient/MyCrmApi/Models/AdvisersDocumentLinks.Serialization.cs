...
{
    public partial class AdvisersDocumentLinks
    {
        internal static AdvisersDocumentLinks DeserializeAdvisersDocumentLinks(JsonElement element)
        {
            ...
            return new AdvisersDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
