...
{
    public partial class ContactGroup : IUtf8JsonSerializable
    {
        ...
        internal static ContactGroup DeserializeContactGroup(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("attributes"))
                {
                    ...
                    attributes = ContactGroupAttributes.DeserializeContactGroupAttributes(property.Value);
                    continue;
                }
                if (property.NameEquals("relationships"))
                {
                    ...
                    relationships = ContactGroupRelationships.DeserializeContactGroupRelationships(property.Value);
                    continue;
                }
                if (property.NameEquals("links"))
                {
                    ...
                    links = ContactGroupLinks.DeserializeContactGroupLinks(property.Value);
                    continue;
                }
            ...
            return new ContactGroup(type, id.Value, attributes.Value, relationships.Value, links.Value, Optional.ToDictionary(meta));
        }
    }
}
