...
{
    public partial class ApiAdviserProfilesDocumentLinks
    {
        internal static ApiAdviserProfilesDocumentLinks DeserializeApiAdviserProfilesDocumentLinks(JsonElement element)
        {
            ...
            return new ApiAdviserProfilesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
