...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static LiabilityDocument DeserializeLiabilityDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<LiabilityDocumentLinks> links = default;
            Liability data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = LiabilityDocumentLinks.DeserializeLiabilityDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Liability.DeserializeLiability(property.Value);
                    continue;
                }
            ...
            return new LiabilityDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
