...
{
    public partial class DealsDocumentLinks
    {
        internal static DealsDocumentLinks DeserializeDealsDocumentLinks(JsonElement element)
        {
            ...
            return new DealsDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
