...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    public partial class ContactGroupsDocument
    {
        ...
        /// <param name="data"></param>
        internal ContactGroupsDocument(IReadOnlyDictionary<string, object> meta, IReadOnlyDictionary<string, object> jsonApi, ContactGroupsDocumentLinks links, IReadOnlyList<ContactGroup> data)
        {
            Meta = meta;
            JsonApi = jsonApi;
            Links = links;
