...
{
    public partial class BusinessRelationshipsEmployments : IUtf8JsonSerializable
    {
        ...
        internal static BusinessRelationshipsEmployments DeserializeBusinessRelationshipsEmployments(JsonElement element)
        {
            ...
            return new BusinessRelationshipsEmployments(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
