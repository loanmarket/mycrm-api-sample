...
{
    public partial class DealSecurityRelationshipsAddress : IUtf8JsonSerializable
    {
        ...
        internal static DealSecurityRelationshipsAddress DeserializeDealSecurityRelationshipsAddress(JsonElement element)
        {
            ...
            return new DealSecurityRelationshipsAddress(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
