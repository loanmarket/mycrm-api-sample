...
{
    public partial class AgreementHolderRelationshipsOrganisation : IUtf8JsonSerializable
    {
        ...
        internal static AgreementHolderRelationshipsOrganisation DeserializeAgreementHolderRelationshipsOrganisation(JsonElement element)
        {
            ...
            return new AgreementHolderRelationshipsOrganisation(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
