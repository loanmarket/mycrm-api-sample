...
{
    public partial class FinancialDocumentLinks
    {
        internal static FinancialDocumentLinks DeserializeFinancialDocumentLinks(JsonElement element)
        {
            ...
            return new FinancialDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
