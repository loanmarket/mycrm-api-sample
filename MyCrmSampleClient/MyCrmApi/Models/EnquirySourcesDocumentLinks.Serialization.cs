...
{
    public partial class EnquirySourcesDocumentLinks
    {
        internal static EnquirySourcesDocumentLinks DeserializeEnquirySourcesDocumentLinks(JsonElement element)
        {
            ...
            return new EnquirySourcesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
