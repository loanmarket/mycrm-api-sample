...
{
    public partial class DealSecurityOwnershipsDocumentLinks
    {
        internal static DealSecurityOwnershipsDocumentLinks DeserializeDealSecurityOwnershipsDocumentLinks(JsonElement element)
        {
            ...
            return new DealSecurityOwnershipsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
