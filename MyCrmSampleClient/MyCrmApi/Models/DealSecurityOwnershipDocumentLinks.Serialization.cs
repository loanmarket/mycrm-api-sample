...
{
    public partial class DealSecurityOwnershipDocumentLinks
    {
        internal static DealSecurityOwnershipDocumentLinks DeserializeDealSecurityOwnershipDocumentLinks(JsonElement element)
        {
            ...
            return new DealSecurityOwnershipDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
