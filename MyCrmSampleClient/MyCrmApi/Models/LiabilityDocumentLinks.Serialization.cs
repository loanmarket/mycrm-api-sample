...
{
    public partial class LiabilityDocumentLinks
    {
        internal static LiabilityDocumentLinks DeserializeLiabilityDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilityDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
