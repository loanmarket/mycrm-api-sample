...
{
    public partial class ContactGroupReferrerDocumentLinks
    {
        internal static ContactGroupReferrerDocumentLinks DeserializeContactGroupReferrerDocumentLinks(JsonElement element)
        {
            ...
            return new ContactGroupReferrerDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
