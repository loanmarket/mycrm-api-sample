...
{
    public partial class DealSecuritiesDocumentLinks
    {
        internal static DealSecuritiesDocumentLinks DeserializeDealSecuritiesDocumentLinks(JsonElement element)
        {
            ...
            return new DealSecuritiesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
