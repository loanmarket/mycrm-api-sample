...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static AssetDocumentLinks DeserializeAssetDocumentLinks(JsonElement element)
        {
            ...
            return new AssetDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
