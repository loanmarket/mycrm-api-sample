...
{
    public partial class AddressDocumentLinks
    {
        internal static AddressDocumentLinks DeserializeAddressDocumentLinks(JsonElement element)
        {
            ...
            return new AddressDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
