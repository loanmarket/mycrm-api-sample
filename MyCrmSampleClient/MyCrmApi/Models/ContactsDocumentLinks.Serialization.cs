...
{
    public partial class ContactsDocumentLinks
    {
        internal static ContactsDocumentLinks DeserializeContactsDocumentLinks(JsonElement element)
        {
            ...
            return new ContactsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
