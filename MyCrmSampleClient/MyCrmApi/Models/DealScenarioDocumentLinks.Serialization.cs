...
{
    public partial class DealScenarioDocumentLinks
    {
        internal static DealScenarioDocumentLinks DeserializeDealScenarioDocumentLinks(JsonElement element)
        {
            ...
            return new DealScenarioDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
