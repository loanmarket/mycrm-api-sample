...
{
    public partial class AssetCategoriesDocumentLinks
    {
        internal static AssetCategoriesDocumentLinks DeserializeAssetCategoriesDocumentLinks(JsonElement element)
        {
            ...
            return new AssetCategoriesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
