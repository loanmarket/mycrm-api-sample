...
{
    public partial class LeadDocument : IUtf8JsonSerializable
    {
        ...
        internal static LeadDocument DeserializeLeadDocument(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = LeadDocumentLinks.DeserializeLeadDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Lead.DeserializeLead(property.Value);
                    continue;
                }
            ...
            return new LeadDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
