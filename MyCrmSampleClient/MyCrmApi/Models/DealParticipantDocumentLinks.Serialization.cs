...
{
    public partial class DealParticipantDocumentLinks
    {
        internal static DealParticipantDocumentLinks DeserializeDealParticipantDocumentLinks(JsonElement element)
        {
            ...
            return new DealParticipantDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
