...
{
    public partial class PropertyTypeDocumentLinks
    {
        internal static PropertyTypeDocumentLinks DeserializePropertyTypeDocumentLinks(JsonElement element)
        {
            ...
            return new PropertyTypeDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
