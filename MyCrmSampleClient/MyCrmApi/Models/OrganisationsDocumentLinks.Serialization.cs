...
{
    public partial class OrganisationsDocumentLinks
    {
        internal static OrganisationsDocumentLinks DeserializeOrganisationsDocumentLinks(JsonElement element)
        {
            ...
            return new OrganisationsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
