...
{
    public partial class AddressesDocumentLinks
    {
        internal static AddressesDocumentLinks DeserializeAddressesDocumentLinks(JsonElement element)
        {
            ...
            return new AddressesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
