...
{
    public partial class OwnersDocumentLinks
    {
        internal static OwnersDocumentLinks DeserializeOwnersDocumentLinks(JsonElement element)
        {
            ...
            return new OwnersDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
