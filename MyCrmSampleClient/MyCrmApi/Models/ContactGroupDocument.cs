...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    public partial class ContactGroupDocument
    {
        ...
        public ContactGroupDocument(ContactGroup data)
        {
            if (data == null)
            {
        ...
        /// <param name="data"></param>
        internal ContactGroupDocument(IReadOnlyDictionary<string, object> meta, IReadOnlyDictionary<string, object> jsonApi, ContactGroupDocumentLinks links, ContactGroup data)
        {
            Meta = meta;
            JsonApi = jsonApi;
            Links = links;
        ...
        public ContactGroup Data { get; set; }
    }
}
