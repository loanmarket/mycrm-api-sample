...
{
    public partial class DealScenarioRelationshipsHighLevelSummary : IUtf8JsonSerializable
    {
        ...
        internal static DealScenarioRelationshipsHighLevelSummary DeserializeDealScenarioRelationshipsHighLevelSummary(JsonElement element)
        {
            ...
            return new DealScenarioRelationshipsHighLevelSummary(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
