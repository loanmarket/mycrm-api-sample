...
{
    public partial class AssetsDocumentLinks
    {
        internal static AssetsDocumentLinks DeserializeAssetsDocumentLinks(JsonElement element)
        {
            ...
            return new AssetsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
