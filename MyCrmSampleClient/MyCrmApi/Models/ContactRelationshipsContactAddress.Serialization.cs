...
{
    public partial class ContactRelationshipsContactAddress : IUtf8JsonSerializable
    {
        ...
        internal static ContactRelationshipsContactAddress DeserializeContactRelationshipsContactAddress(JsonElement element)
        {
            ...
            return new ContactRelationshipsContactAddress(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
