...
{
    public partial class ContactGroupRelationshipsReferrerOrganisation : IUtf8JsonSerializable
    {
        ...
        internal static ContactGroupRelationshipsReferrerOrganisation DeserializeContactGroupRelationshipsReferrerOrganisation(JsonElement element)
        {
            ...
            return new ContactGroupRelationshipsReferrerOrganisation(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
