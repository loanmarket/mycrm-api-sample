...
{
    public partial class IncomesDocumentLinks
    {
        internal static IncomesDocumentLinks DeserializeIncomesDocumentLinks(JsonElement element)
        {
            ...
            return new IncomesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
