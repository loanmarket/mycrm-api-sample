...
{
    public partial class StructuredLeadDocumentLinks
    {
        internal static StructuredLeadDocumentLinks DeserializeStructuredLeadDocumentLinks(JsonElement element)
        {
            ...
            return new StructuredLeadDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
