...
{
    public partial class DealImportantDatesDocumentLinks
    {
        internal static DealImportantDatesDocumentLinks DeserializeDealImportantDatesDocumentLinks(JsonElement element)
        {
            ...
            return new DealImportantDatesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
