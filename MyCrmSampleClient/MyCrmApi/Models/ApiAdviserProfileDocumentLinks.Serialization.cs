...
{
    public partial class ApiAdviserProfileDocumentLinks
    {
        internal static ApiAdviserProfileDocumentLinks DeserializeApiAdviserProfileDocumentLinks(JsonElement element)
        {
            ...
            return new ApiAdviserProfileDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
