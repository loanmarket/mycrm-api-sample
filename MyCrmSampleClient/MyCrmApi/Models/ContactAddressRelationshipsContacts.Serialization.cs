...
{
    public partial class ContactAddressRelationshipsContacts : IUtf8JsonSerializable
    {
        ...
        internal static ContactAddressRelationshipsContacts DeserializeContactAddressRelationshipsContacts(JsonElement element)
        {
            ...
            return new ContactAddressRelationshipsContacts(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
