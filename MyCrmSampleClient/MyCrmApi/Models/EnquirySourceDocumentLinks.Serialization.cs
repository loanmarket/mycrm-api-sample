...
{
    public partial class EnquirySourceDocumentLinks
    {
        internal static EnquirySourceDocumentLinks DeserializeEnquirySourceDocumentLinks(JsonElement element)
        {
            ...
            return new EnquirySourceDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
