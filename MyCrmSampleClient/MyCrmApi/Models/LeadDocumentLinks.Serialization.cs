...
{
    public partial class LeadDocumentLinks
    {
        internal static LeadDocumentLinks DeserializeLeadDocumentLinks(JsonElement element)
        {
            ...
            return new LeadDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
