...
{
    public partial class DealStructureImportantDateRelationshipsDealStructure : IUtf8JsonSerializable
    {
        ...
        internal static DealStructureImportantDateRelationshipsDealStructure DeserializeDealStructureImportantDateRelationshipsDealStructure(JsonElement element)
        {
            ...
            return new DealStructureImportantDateRelationshipsDealStructure(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
