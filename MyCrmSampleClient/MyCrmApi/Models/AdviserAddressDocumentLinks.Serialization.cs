...
{
    public partial class AdviserAddressDocumentLinks
    {
        internal static AdviserAddressDocumentLinks DeserializeAdviserAddressDocumentLinks(JsonElement element)
        {
            ...
            return new AdviserAddressDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
