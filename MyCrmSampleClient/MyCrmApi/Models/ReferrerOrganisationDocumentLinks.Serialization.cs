...
{
    public partial class ReferrerOrganisationDocumentLinks
    {
        internal static ReferrerOrganisationDocumentLinks DeserializeReferrerOrganisationDocumentLinks(JsonElement element)
        {
            ...
            return new ReferrerOrganisationDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
