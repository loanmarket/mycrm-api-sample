...
{
    public partial class DealSecurityRelationshipsAsset : IUtf8JsonSerializable
    {
        ...
        internal static DealSecurityRelationshipsAsset DeserializeDealSecurityRelationshipsAsset(JsonElement element)
        {
            ...
            return new DealSecurityRelationshipsAsset(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
