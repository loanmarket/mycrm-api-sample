...
{
    public partial class DealSecurityTitleIdentityDocumentLinks
    {
        internal static DealSecurityTitleIdentityDocumentLinks DeserializeDealSecurityTitleIdentityDocumentLinks(JsonElement element)
        {
            ...
            return new DealSecurityTitleIdentityDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
