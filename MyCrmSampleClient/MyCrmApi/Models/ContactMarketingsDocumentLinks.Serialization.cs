...
{
    public partial class ContactMarketingsDocumentLinks
    {
        internal static ContactMarketingsDocumentLinks DeserializeContactMarketingsDocumentLinks(JsonElement element)
        {
            ...
            return new ContactMarketingsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
