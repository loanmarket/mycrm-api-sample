...
{
    public partial class StructuredLeadsDocumentLinks
    {
        internal static StructuredLeadsDocumentLinks DeserializeStructuredLeadsDocumentLinks(JsonElement element)
        {
            ...
            return new StructuredLeadsDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
