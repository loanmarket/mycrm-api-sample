...
{
    public partial class DealParticipantsDocumentLinks
    {
        internal static DealParticipantsDocumentLinks DeserializeDealParticipantsDocumentLinks(JsonElement element)
        {
            ...
            return new DealParticipantsDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
