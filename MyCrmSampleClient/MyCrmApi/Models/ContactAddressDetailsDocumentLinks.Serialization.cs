...
{
    public partial class ContactAddressDetailsDocumentLinks
    {
        internal static ContactAddressDetailsDocumentLinks DeserializeContactAddressDetailsDocumentLinks(JsonElement element)
        {
            ...
            return new ContactAddressDetailsDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
