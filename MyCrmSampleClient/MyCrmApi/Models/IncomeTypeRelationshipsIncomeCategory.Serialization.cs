...
{
    public partial class IncomeTypeRelationshipsIncomeCategory : IUtf8JsonSerializable
    {
        ...
        internal static IncomeTypeRelationshipsIncomeCategory DeserializeIncomeTypeRelationshipsIncomeCategory(JsonElement element)
        {
            ...
            return new IncomeTypeRelationshipsIncomeCategory(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
