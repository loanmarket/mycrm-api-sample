...
{
    public partial class LiabilityTypeDocumentLinks
    {
        internal static LiabilityTypeDocumentLinks DeserializeLiabilityTypeDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilityTypeDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
