...
{
    public partial class DealDocumentLinks
    {
        internal static DealDocumentLinks DeserializeDealDocumentLinks(JsonElement element)
        {
            ...
            return new DealDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
