...
{
    public partial class ResourceObjectDocumentLinks
    {
        internal static ResourceObjectDocumentLinks DeserializeResourceObjectDocumentLinks(JsonElement element)
        {
            ...
            return new ResourceObjectDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
