...
{
    public partial class AssetCategoryDocumentLinks
    {
        internal static AssetCategoryDocumentLinks DeserializeAssetCategoryDocumentLinks(JsonElement element)
        {
            ...
            return new AssetCategoryDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
