...
{
    public partial class OwnerRelationshipsIncome : IUtf8JsonSerializable
    {
        ...
        internal static OwnerRelationshipsIncome DeserializeOwnerRelationshipsIncome(JsonElement element)
        {
            ...
            return new OwnerRelationshipsIncome(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
