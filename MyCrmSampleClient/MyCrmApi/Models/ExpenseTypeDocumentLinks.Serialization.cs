...
{
    public partial class ExpenseTypeDocumentLinks
    {
        internal static ExpenseTypeDocumentLinks DeserializeExpenseTypeDocumentLinks(JsonElement element)
        {
            ...
            return new ExpenseTypeDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
