...
{
    public partial class OrganisationAddressesDocumentLinks
    {
        internal static OrganisationAddressesDocumentLinks DeserializeOrganisationAddressesDocumentLinks(JsonElement element)
        {
            ...
            return new OrganisationAddressesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
