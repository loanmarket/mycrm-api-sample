...
{
    public partial class ContactGroupDocument : IUtf8JsonSerializable
    {
        ...
        internal static ContactGroupDocument DeserializeContactGroupDocument(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = ContactGroupDocumentLinks.DeserializeContactGroupDocumentLinks(property.Value);
                    continue;
                }
