...
{
    public partial class ContactGroupDocumentLinks
    {
        internal static ContactGroupDocumentLinks DeserializeContactGroupDocumentLinks(JsonElement element)
        {
            ...
            return new ContactGroupDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
