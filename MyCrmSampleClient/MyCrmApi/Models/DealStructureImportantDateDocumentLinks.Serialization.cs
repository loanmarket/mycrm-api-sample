...
{
    public partial class DealStructureImportantDateDocumentLinks
    {
        internal static DealStructureImportantDateDocumentLinks DeserializeDealStructureImportantDateDocumentLinks(JsonElement element)
        {
            ...
            return new DealStructureImportantDateDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
