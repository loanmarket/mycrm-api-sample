...
{
    public partial class ContactAddressDetailDocumentLinks
    {
        internal static ContactAddressDetailDocumentLinks DeserializeContactAddressDetailDocumentLinks(JsonElement element)
        {
            ...
            return new ContactAddressDetailDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
