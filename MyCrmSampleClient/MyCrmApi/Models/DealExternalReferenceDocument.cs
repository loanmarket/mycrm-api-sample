...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    public partial class DealExternalReferenceDocument
    {
        ...
        /// <param name="data"></param>
        internal DealExternalReferenceDocument(IReadOnlyDictionary<string, object> meta, IReadOnlyDictionary<string, object> jsonApi, DealExternalReferenceDocumentLinks links, DealExternalReference data)
        {
            Meta = meta;
            JsonApi = jsonApi;
            Links = links;
