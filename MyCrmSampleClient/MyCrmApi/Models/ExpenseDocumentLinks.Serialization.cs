...
{
    public partial class ExpenseDocumentLinks
    {
        internal static ExpenseDocumentLinks DeserializeExpenseDocumentLinks(JsonElement element)
        {
            ...
            return new ExpenseDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
