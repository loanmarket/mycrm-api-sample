...
{
    public partial class ReferrerDocumentLinks
    {
        internal static ReferrerDocumentLinks DeserializeReferrerDocumentLinks(JsonElement element)
        {
            ...
            return new ReferrerDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
