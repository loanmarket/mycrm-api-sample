...
{
    public partial class LiabilityCategoryRelationshipsLiabilityTypes : IUtf8JsonSerializable
    {
        ...
        internal static LiabilityCategoryRelationshipsLiabilityTypes DeserializeLiabilityCategoryRelationshipsLiabilityTypes(JsonElement element)
        {
            ...
            return new LiabilityCategoryRelationshipsLiabilityTypes(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
