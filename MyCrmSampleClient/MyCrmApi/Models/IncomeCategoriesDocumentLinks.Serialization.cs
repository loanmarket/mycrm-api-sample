...
{
    public partial class IncomeCategoriesDocumentLinks
    {
        internal static IncomeCategoriesDocumentLinks DeserializeIncomeCategoriesDocumentLinks(JsonElement element)
        {
            ...
            return new IncomeCategoriesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
