...
{
    public partial class AgreementHoldersDocumentLinks
    {
        internal static AgreementHoldersDocumentLinks DeserializeAgreementHoldersDocumentLinks(JsonElement element)
        {
            ...
            return new AgreementHoldersDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
