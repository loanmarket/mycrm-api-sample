...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    public partial class Address : IUtf8JsonSerializable
    {
        ...
        {
            Optional<AddressAttributes> attributes = default;
            Optional<AddressRelationships> relationships = default;
            Optional<AddressLinks> links = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("attributes"))
                {
                    ...
                    attributes = AddressAttributes.DeserializeAddressAttributes(property.Value);
                    continue;
                }
                if (property.NameEquals("relationships"))
                {
                    ...
                    relationships = AddressRelationships.DeserializeAddressRelationships(property.Value);
                    continue;
                }
                if (property.NameEquals("links"))
                {
                    ...
                    links = AddressLinks.DeserializeAddressLinks(property.Value);
                    continue;
                }
            ...
            return new Address(type, id.Value, attributes.Value, relationships.Value, links.Value, Optional.ToDictionary(meta));
        }
    }
}
