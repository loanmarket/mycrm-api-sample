...
{
    public partial class BusinessDocumentLinks
    {
        internal static BusinessDocumentLinks DeserializeBusinessDocumentLinks(JsonElement element)
        {
            ...
            return new BusinessDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
