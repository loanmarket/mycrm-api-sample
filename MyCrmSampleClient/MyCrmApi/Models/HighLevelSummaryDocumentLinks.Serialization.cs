...
{
    public partial class HighLevelSummaryDocumentLinks
    {
        internal static HighLevelSummaryDocumentLinks DeserializeHighLevelSummaryDocumentLinks(JsonElement element)
        {
            ...
            return new HighLevelSummaryDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
