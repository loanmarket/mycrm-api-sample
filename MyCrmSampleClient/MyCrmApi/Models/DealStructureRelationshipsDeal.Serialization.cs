...
{
    public partial class DealStructureRelationshipsDeal : IUtf8JsonSerializable
    {
        ...
        internal static DealStructureRelationshipsDeal DeserializeDealStructureRelationshipsDeal(JsonElement element)
        {
            ...
            return new DealStructureRelationshipsDeal(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
