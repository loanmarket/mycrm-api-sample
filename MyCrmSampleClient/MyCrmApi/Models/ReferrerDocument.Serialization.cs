...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static ReferrerDocument DeserializeReferrerDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<ReferrerDocumentLinks> links = default;
            Referrer data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = ReferrerDocumentLinks.DeserializeReferrerDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Referrer.DeserializeReferrer(property.Value);
                    continue;
                }
            ...
            return new ReferrerDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
