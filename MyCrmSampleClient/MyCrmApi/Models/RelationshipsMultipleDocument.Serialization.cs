...
{
    public partial class RelationshipsMultipleDocument : IUtf8JsonSerializable
    {
        ...
        internal static RelationshipsMultipleDocument DeserializeRelationshipsMultipleDocument(JsonElement element)
        {
            ...
            return new RelationshipsMultipleDocument(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
