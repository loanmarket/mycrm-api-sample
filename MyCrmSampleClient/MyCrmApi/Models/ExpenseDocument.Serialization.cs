...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static ExpenseDocument DeserializeExpenseDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<ExpenseDocumentLinks> links = default;
            Expense data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = ExpenseDocumentLinks.DeserializeExpenseDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Expense.DeserializeExpense(property.Value);
                    continue;
                }
            ...
            return new ExpenseDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
