...
{
    public partial class OwnerDocumentLinks
    {
        internal static OwnerDocumentLinks DeserializeOwnerDocumentLinks(JsonElement element)
        {
            ...
            return new OwnerDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
