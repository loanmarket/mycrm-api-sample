...
{
    public partial class LiabilityTypesDocumentLinks
    {
        internal static LiabilityTypesDocumentLinks DeserializeLiabilityTypesDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilityTypesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
