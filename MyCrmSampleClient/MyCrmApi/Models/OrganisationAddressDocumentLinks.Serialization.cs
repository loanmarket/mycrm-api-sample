...
{
    public partial class OrganisationAddressDocumentLinks
    {
        internal static OrganisationAddressDocumentLinks DeserializeOrganisationAddressDocumentLinks(JsonElement element)
        {
            ...
            return new OrganisationAddressDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
