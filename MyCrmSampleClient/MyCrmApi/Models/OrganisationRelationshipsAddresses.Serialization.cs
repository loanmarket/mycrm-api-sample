...
{
    public partial class OrganisationRelationshipsAddresses : IUtf8JsonSerializable
    {
        ...
        internal static OrganisationRelationshipsAddresses DeserializeOrganisationRelationshipsAddresses(JsonElement element)
        {
            ...
            return new OrganisationRelationshipsAddresses(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
