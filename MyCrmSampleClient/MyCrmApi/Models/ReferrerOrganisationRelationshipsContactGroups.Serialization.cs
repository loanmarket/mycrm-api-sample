...
{
    public partial class ReferrerOrganisationRelationshipsContactGroups : IUtf8JsonSerializable
    {
        ...
        internal static ReferrerOrganisationRelationshipsContactGroups DeserializeReferrerOrganisationRelationshipsContactGroups(JsonElement element)
        {
            ...
            return new ReferrerOrganisationRelationshipsContactGroups(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
