...
{
    public partial class ReferrerMembersDocumentLinks
    {
        internal static ReferrerMembersDocumentLinks DeserializeReferrerMembersDocumentLinks(JsonElement element)
        {
            ...
            return new ReferrerMembersDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
