...
{
    public partial class AgreementHolderDocumentLinks
    {
        internal static AgreementHolderDocumentLinks DeserializeAgreementHolderDocumentLinks(JsonElement element)
        {
            ...
            return new AgreementHolderDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
