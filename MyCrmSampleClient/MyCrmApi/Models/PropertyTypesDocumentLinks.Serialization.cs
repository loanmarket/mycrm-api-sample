...
{
    public partial class PropertyTypesDocumentLinks
    {
        internal static PropertyTypesDocumentLinks DeserializePropertyTypesDocumentLinks(JsonElement element)
        {
            ...
            return new PropertyTypesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
