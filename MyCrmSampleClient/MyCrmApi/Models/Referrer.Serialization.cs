...
{
    public partial class Referrer : IUtf8JsonSerializable
    {
        ...
        internal static Referrer DeserializeReferrer(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("attributes"))
                {
                    ...
                    attributes = ReferrerAttributes.DeserializeReferrerAttributes(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = ReferrerLinks.DeserializeReferrerLinks(property.Value);
                    continue;
                }
            ...
            return new Referrer(type, id.Value, attributes.Value, relationships.Value, links.Value, Optional.ToDictionary(meta));
        }
    }
}
