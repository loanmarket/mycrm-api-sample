...
{
    public partial class FinancialAddressDocumentLinks
    {
        internal static FinancialAddressDocumentLinks DeserializeFinancialAddressDocumentLinks(JsonElement element)
        {
            ...
            return new FinancialAddressDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
