...
{
    public partial class ContactAddressDocumentLinks
    {
        internal static ContactAddressDocumentLinks DeserializeContactAddressDocumentLinks(JsonElement element)
        {
            ...
            return new ContactAddressDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
