...
{
    public partial class ContactExternalReferenceDocumentLinks
    {
        internal static ContactExternalReferenceDocumentLinks DeserializeContactExternalReferenceDocumentLinks(JsonElement element)
        {
            ...
            return new ContactExternalReferenceDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
