...
{
    public partial class ContactExternalReferencesDocumentLinks
    {
        internal static ContactExternalReferencesDocumentLinks DeserializeContactExternalReferencesDocumentLinks(JsonElement element)
        {
            ...
            return new ContactExternalReferencesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
