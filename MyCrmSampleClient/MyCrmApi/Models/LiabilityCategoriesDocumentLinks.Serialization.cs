...
{
    public partial class LiabilityCategoriesDocumentLinks
    {
        internal static LiabilityCategoriesDocumentLinks DeserializeLiabilityCategoriesDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilityCategoriesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
