...
{
    public partial class AssetTypeDocumentLinks
    {
        internal static AssetTypeDocumentLinks DeserializeAssetTypeDocumentLinks(JsonElement element)
        {
            ...
            return new AssetTypeDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
