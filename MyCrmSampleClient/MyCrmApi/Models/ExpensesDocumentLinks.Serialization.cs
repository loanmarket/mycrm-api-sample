...
{
    public partial class ExpensesDocumentLinks
    {
        internal static ExpensesDocumentLinks DeserializeExpensesDocumentLinks(JsonElement element)
        {
            ...
            return new ExpensesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
