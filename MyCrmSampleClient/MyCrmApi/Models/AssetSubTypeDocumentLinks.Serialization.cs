...
{
    public partial class AssetSubTypeDocumentLinks
    {
        internal static AssetSubTypeDocumentLinks DeserializeAssetSubTypeDocumentLinks(JsonElement element)
        {
            ...
            return new AssetSubTypeDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
