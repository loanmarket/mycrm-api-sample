...
{
    public partial class DealExternalReferencesDocumentLinks
    {
        internal static DealExternalReferencesDocumentLinks DeserializeDealExternalReferencesDocumentLinks(JsonElement element)
        {
            ...
            return new DealExternalReferencesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
