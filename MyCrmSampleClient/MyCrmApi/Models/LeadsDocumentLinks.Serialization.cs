...
{
    public partial class LeadsDocumentLinks
    {
        internal static LeadsDocumentLinks DeserializeLeadsDocumentLinks(JsonElement element)
        {
            ...
            return new LeadsDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
