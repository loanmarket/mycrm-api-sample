...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    public partial class DealExternalReferenceDocument : IUtf8JsonSerializable
    {
        ...
        internal static DealExternalReferenceDocument DeserializeDealExternalReferenceDocument(JsonElement element)
        {
            ...
            Optional<DealExternalReferenceDocumentLinks> links = default;
            DealExternalReference data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = DealExternalReferenceDocumentLinks.DeserializeDealExternalReferenceDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = DealExternalReference.DeserializeDealExternalReference(property.Value);
                    continue;
                }
            ...
            return new DealExternalReferenceDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
