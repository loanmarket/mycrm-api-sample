...
{
    public partial class AssetSubTypesDocumentLinks
    {
        internal static AssetSubTypesDocumentLinks DeserializeAssetSubTypesDocumentLinks(JsonElement element)
        {
            ...
            return new AssetSubTypesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
