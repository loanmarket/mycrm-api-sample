...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static TopLevelLinks DeserializeTopLevelLinks(JsonElement element)
        {
            ...
            return new TopLevelLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
