...
{
    public partial class FinancialAddressesDocumentLinks
    {
        internal static FinancialAddressesDocumentLinks DeserializeFinancialAddressesDocumentLinks(JsonElement element)
        {
            ...
            return new FinancialAddressesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
