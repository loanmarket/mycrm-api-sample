...
{
    public partial class DealStructuresDocumentLinks
    {
        internal static DealStructuresDocumentLinks DeserializeDealStructuresDocumentLinks(JsonElement element)
        {
            ...
            return new DealStructuresDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
