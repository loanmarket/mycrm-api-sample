...
{
    public partial class ExpenseTypeRelationshipsExpenseCategory : IUtf8JsonSerializable
    {
        ...
        internal static ExpenseTypeRelationshipsExpenseCategory DeserializeExpenseTypeRelationshipsExpenseCategory(JsonElement element)
        {
            ...
            return new ExpenseTypeRelationshipsExpenseCategory(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
