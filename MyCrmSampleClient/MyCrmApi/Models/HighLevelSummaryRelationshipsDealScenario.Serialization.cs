...
{
    public partial class HighLevelSummaryRelationshipsDealScenario : IUtf8JsonSerializable
    {
        ...
        internal static HighLevelSummaryRelationshipsDealScenario DeserializeHighLevelSummaryRelationshipsDealScenario(JsonElement element)
        {
            ...
            return new HighLevelSummaryRelationshipsDealScenario(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
