...
{
    public partial class ContactRelationshipsEmployments : IUtf8JsonSerializable
    {
        ...
        internal static ContactRelationshipsEmployments DeserializeContactRelationshipsEmployments(JsonElement element)
        {
            ...
            return new ContactRelationshipsEmployments(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
