...
{
    public partial class IncomeTypeDocumentLinks
    {
        internal static IncomeTypeDocumentLinks DeserializeIncomeTypeDocumentLinks(JsonElement element)
        {
            ...
            return new IncomeTypeDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
