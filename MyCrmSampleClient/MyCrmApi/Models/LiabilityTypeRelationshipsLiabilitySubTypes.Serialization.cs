...
{
    public partial class LiabilityTypeRelationshipsLiabilitySubTypes : IUtf8JsonSerializable
    {
        ...
        internal static LiabilityTypeRelationshipsLiabilitySubTypes DeserializeLiabilityTypeRelationshipsLiabilitySubTypes(JsonElement element)
        {
            ...
            return new LiabilityTypeRelationshipsLiabilitySubTypes(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
