...
{
    public partial class ExpenseCategoryRelationshipsExpenseTypes : IUtf8JsonSerializable
    {
        ...
        internal static ExpenseCategoryRelationshipsExpenseTypes DeserializeExpenseCategoryRelationshipsExpenseTypes(JsonElement element)
        {
            ...
            return new ExpenseCategoryRelationshipsExpenseTypes(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
