...
{
    public partial class ContactGroupReferrersDocumentLinks
    {
        internal static ContactGroupReferrersDocumentLinks DeserializeContactGroupReferrersDocumentLinks(JsonElement element)
        {
            ...
            return new ContactGroupReferrersDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
