...
{
    public partial class AssetTypesDocumentLinks
    {
        internal static AssetTypesDocumentLinks DeserializeAssetTypesDocumentLinks(JsonElement element)
        {
            ...
            return new AssetTypesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
