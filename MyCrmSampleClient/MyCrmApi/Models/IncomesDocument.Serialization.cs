...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static IncomesDocument DeserializeIncomesDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<IncomesDocumentLinks> links = default;
            IReadOnlyList<Income> data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = IncomesDocumentLinks.DeserializeIncomesDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    List<Income> array = new List<Income>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(Income.DeserializeIncome(item));
                    }
                    data = array;
                    continue;
                }
            ...
            return new IncomesDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
