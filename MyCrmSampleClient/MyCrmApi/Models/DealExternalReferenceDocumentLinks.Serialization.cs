...
{
    public partial class DealExternalReferenceDocumentLinks
    {
        internal static DealExternalReferenceDocumentLinks DeserializeDealExternalReferenceDocumentLinks(JsonElement element)
        {
            ...
            return new DealExternalReferenceDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
