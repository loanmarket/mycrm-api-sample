...
{
    public partial class Lead : IUtf8JsonSerializable
    {
        ...
        internal static Lead DeserializeLead(JsonElement element)
        {
            Optional<LeadAttributes> attributes = default;
            Optional<object> relationships = default;
            Optional<LeadLinks> links = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("attributes"))
                {
                    ...
                    attributes = LeadAttributes.DeserializeLeadAttributes(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = LeadLinks.DeserializeLeadLinks(property.Value);
                    continue;
                }
            ...
            return new Lead(type, id.Value, attributes.Value, relationships.Value, links.Value, Optional.ToDictionary(meta));
        }
    }
}
