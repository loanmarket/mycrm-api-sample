...
{
    public partial class LiabilitiesDocumentLinks
    {
        internal static LiabilitiesDocumentLinks DeserializeLiabilitiesDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilitiesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
