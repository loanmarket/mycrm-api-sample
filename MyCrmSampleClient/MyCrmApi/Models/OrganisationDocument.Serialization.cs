...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static OrganisationDocument DeserializeOrganisationDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<OrganisationDocumentLinks> links = default;
            Organisation data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = OrganisationDocumentLinks.DeserializeOrganisationDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Organisation.DeserializeOrganisation(property.Value);
                    continue;
                }
            ...
            return new OrganisationDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
