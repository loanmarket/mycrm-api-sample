...
{
    public partial class IncomeCategoryRelationshipsIncomeTypes : IUtf8JsonSerializable
    {
        ...
        internal static IncomeCategoryRelationshipsIncomeTypes DeserializeIncomeCategoryRelationshipsIncomeTypes(JsonElement element)
        {
            ...
            return new IncomeCategoryRelationshipsIncomeTypes(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
