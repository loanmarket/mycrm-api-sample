...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static IncomeDocument DeserializeIncomeDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<IncomeDocumentLinks> links = default;
            Income data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = IncomeDocumentLinks.DeserializeIncomeDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Income.DeserializeIncome(property.Value);
                    continue;
                }
            ...
            return new IncomeDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
