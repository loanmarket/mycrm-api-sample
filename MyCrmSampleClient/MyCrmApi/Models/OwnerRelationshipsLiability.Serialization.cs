...
{
    public partial class OwnerRelationshipsLiability : IUtf8JsonSerializable
    {
        ...
        internal static OwnerRelationshipsLiability DeserializeOwnerRelationshipsLiability(JsonElement element)
        {
            ...
            return new OwnerRelationshipsLiability(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
