...
{
    public partial class OwnerRelationshipsExpense : IUtf8JsonSerializable
    {
        ...
        internal static OwnerRelationshipsExpense DeserializeOwnerRelationshipsExpense(JsonElement element)
        {
            ...
            return new OwnerRelationshipsExpense(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
