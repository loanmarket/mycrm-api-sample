...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    public partial class ContactExternalReferenceDocument
    {
        ...
        internal ContactExternalReferenceDocument(IReadOnlyDictionary<string, object> meta, IReadOnlyDictionary<string, object> jsonApi, ContactExternalReferenceDocumentLinks links, ContactExternalReference data, IReadOnlyList<IncludedResource> included)
        {
            Meta = meta;
            JsonApi = jsonApi;
            Links = links;
