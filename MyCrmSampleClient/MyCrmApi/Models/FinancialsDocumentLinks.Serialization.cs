...
{
    public partial class FinancialsDocumentLinks
    {
        internal static FinancialsDocumentLinks DeserializeFinancialsDocumentLinks(JsonElement element)
        {
            ...
            return new FinancialsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
