...
{
    public partial class ReferrerMemberDocumentLinks
    {
        internal static ReferrerMemberDocumentLinks DeserializeReferrerMemberDocumentLinks(JsonElement element)
        {
            ...
            return new ReferrerMemberDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
