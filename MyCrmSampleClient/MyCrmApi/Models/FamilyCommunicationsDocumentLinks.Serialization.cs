...
{
    public partial class FamilyCommunicationsDocumentLinks
    {
        internal static FamilyCommunicationsDocumentLinks DeserializeFamilyCommunicationsDocumentLinks(JsonElement element)
        {
            ...
            return new FamilyCommunicationsDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
