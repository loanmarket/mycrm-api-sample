...
{
    public partial class ReferrersDocumentLinks
    {
        internal static ReferrersDocumentLinks DeserializeReferrersDocumentLinks(JsonElement element)
        {
            ...
            return new ReferrersDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
