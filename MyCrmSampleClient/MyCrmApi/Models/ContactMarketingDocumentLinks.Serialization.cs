...
{
    public partial class ContactMarketingDocumentLinks
    {
        internal static ContactMarketingDocumentLinks DeserializeContactMarketingDocumentLinks(JsonElement element)
        {
            ...
            return new ContactMarketingDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
