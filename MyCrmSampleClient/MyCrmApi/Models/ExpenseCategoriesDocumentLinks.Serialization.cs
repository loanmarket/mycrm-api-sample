...
{
    public partial class ExpenseCategoriesDocumentLinks
    {
        internal static ExpenseCategoriesDocumentLinks DeserializeExpenseCategoriesDocumentLinks(JsonElement element)
        {
            ...
            return new ExpenseCategoriesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
