...
{
    public partial class ContactAddressesDocumentLinks
    {
        internal static ContactAddressesDocumentLinks DeserializeContactAddressesDocumentLinks(JsonElement element)
        {
            ...
            return new ContactAddressesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
