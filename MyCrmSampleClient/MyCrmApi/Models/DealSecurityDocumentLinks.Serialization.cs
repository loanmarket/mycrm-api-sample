...
{
    public partial class DealSecurityDocumentLinks
    {
        internal static DealSecurityDocumentLinks DeserializeDealSecurityDocumentLinks(JsonElement element)
        {
            ...
            return new DealSecurityDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
