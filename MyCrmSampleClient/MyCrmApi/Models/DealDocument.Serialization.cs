...
{
    public partial class DealDocument : IUtf8JsonSerializable
    {
        ...
        internal static DealDocument DeserializeDealDocument(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = DealDocumentLinks.DeserializeDealDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Deal.DeserializeDeal(property.Value);
                    continue;
                }
            ...
            return new DealDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
