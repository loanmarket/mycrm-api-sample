...
{
    public partial class LiabilitySubTypesDocumentLinks
    {
        internal static LiabilitySubTypesDocumentLinks DeserializeLiabilitySubTypesDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilitySubTypesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
