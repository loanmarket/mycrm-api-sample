...
{
    public partial class BusinessesDocumentLinks
    {
        internal static BusinessesDocumentLinks DeserializeBusinessesDocumentLinks(JsonElement element)
        {
            ...
            return new BusinessesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
