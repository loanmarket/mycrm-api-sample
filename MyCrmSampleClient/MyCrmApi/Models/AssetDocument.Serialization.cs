...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    {
        internal static AssetDocument DeserializeAssetDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<AssetDocumentLinks> links = default;
            Asset data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = AssetDocumentLinks.DeserializeAssetDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Asset.DeserializeAsset(property.Value);
                    continue;
                }
            ...
            return new AssetDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
