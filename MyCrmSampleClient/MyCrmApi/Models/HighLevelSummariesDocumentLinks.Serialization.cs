...
{
    public partial class HighLevelSummariesDocumentLinks
    {
        internal static HighLevelSummariesDocumentLinks DeserializeHighLevelSummariesDocumentLinks(JsonElement element)
        {
            ...
            return new HighLevelSummariesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
