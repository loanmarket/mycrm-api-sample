...
{
    public partial class DealStructureDocumentLinks
    {
        internal static DealStructureDocumentLinks DeserializeDealStructureDocumentLinks(JsonElement element)
        {
            ...
            return new DealStructureDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
