...
{
    public partial class FamilyCommunicationDocumentLinks
    {
        internal static FamilyCommunicationDocumentLinks DeserializeFamilyCommunicationDocumentLinks(JsonElement element)
        {
            ...
            return new FamilyCommunicationDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
