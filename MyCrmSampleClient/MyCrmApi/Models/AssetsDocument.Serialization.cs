...
{
    public partial class AssetsDocument
    {
        internal static AssetsDocument DeserializeAssetsDocument(JsonElement element)
        {
            Optional<IReadOnlyDictionary<string, object>> meta = default;
            Optional<IReadOnlyDictionary<string, object>> jsonApi = default;
            Optional<AssetsDocumentLinks> links = default;
            IReadOnlyList<Asset> data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = AssetsDocumentLinks.DeserializeAssetsDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    ...
                    {
                        array.Add(Asset.DeserializeAsset(item));
                    }
                    data = array;
                    continue;
                }
            ...
            return new AssetsDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
