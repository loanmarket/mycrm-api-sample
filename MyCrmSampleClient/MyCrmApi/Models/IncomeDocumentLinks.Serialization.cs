...
{
    public partial class IncomeDocumentLinks
    {
        internal static IncomeDocumentLinks DeserializeIncomeDocumentLinks(JsonElement element)
        {
            ...
            return new IncomeDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
