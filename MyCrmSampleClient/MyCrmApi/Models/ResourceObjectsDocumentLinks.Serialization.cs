...
{
    public partial class ResourceObjectsDocumentLinks
    {
        internal static ResourceObjectsDocumentLinks DeserializeResourceObjectsDocumentLinks(JsonElement element)
        {
            ...
            return new ResourceObjectsDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
