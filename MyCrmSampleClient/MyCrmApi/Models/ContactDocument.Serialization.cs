...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    public partial class ContactDocument
    {
        internal static ContactDocument DeserializeContactDocument(JsonElement element)
        {
            ...
            Optional<ContactDocumentLinks> links = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = ContactDocumentLinks.DeserializeContactDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    data = Contact.DeserializeContact(property.Value);
                    continue;
                }
            ...
            return new ContactDocument(Optional.ToDictionary(meta), Optional.ToDictionary(jsonApi), links.Value, data, Optional.ToList(included));
        }
    }
}
