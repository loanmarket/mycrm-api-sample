...
{
    public partial class AdviserDetailDocumentLinks
    {
        internal static AdviserDetailDocumentLinks DeserializeAdviserDetailDocumentLinks(JsonElement element)
        {
            ...
            return new AdviserDetailDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
