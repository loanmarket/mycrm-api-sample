        ...
        internal static DealExternalReferencesDocument DeserializeDealExternalReferencesDocument(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("links"))
                {
                    ...
                    links = DealExternalReferencesDocumentLinks.DeserializeDealExternalReferencesDocumentLinks(property.Value);
                    continue;
                }
                if (property.NameEquals("data"))
                {
                    List<DealExternalReference> array = new List<DealExternalReference>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DealExternalReference.DeserializeDealExternalReference(item));
                    }
                    data = array;
                    continue;
                }
