...
{
    public partial class ExpenseTypesDocumentLinks
    {
        internal static ExpenseTypesDocumentLinks DeserializeExpenseTypesDocumentLinks(JsonElement element)
        {
            ...
            return new ExpenseTypesDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
