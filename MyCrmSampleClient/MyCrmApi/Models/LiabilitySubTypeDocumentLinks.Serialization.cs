...
{
    public partial class LiabilitySubTypeDocumentLinks
    {
        internal static LiabilitySubTypeDocumentLinks DeserializeLiabilitySubTypeDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilitySubTypeDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
