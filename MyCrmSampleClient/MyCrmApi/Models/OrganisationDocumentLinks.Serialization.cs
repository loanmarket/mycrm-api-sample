...
{
    public partial class OrganisationDocumentLinks
    {
        internal static OrganisationDocumentLinks DeserializeOrganisationDocumentLinks(JsonElement element)
        {
            ...
            return new OrganisationDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
