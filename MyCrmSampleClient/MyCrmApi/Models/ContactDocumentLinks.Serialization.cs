...
{
    public partial class ContactDocumentLinks
    {
        internal static ContactDocumentLinks DeserializeContactDocumentLinks(JsonElement element)
        {
            ...
            return new ContactDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
