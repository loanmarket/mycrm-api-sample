...
{
    public partial class AdviserDocumentLinks
    {
        internal static AdviserDocumentLinks DeserializeAdviserDocumentLinks(JsonElement element)
        {
            ...
            return new AdviserDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
