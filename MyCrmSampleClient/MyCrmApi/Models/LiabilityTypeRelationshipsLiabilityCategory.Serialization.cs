...
{
    public partial class LiabilityTypeRelationshipsLiabilityCategory : IUtf8JsonSerializable
    {
        ...
        internal static LiabilityTypeRelationshipsLiabilityCategory DeserializeLiabilityTypeRelationshipsLiabilityCategory(JsonElement element)
        {
            ...
            return new LiabilityTypeRelationshipsLiabilityCategory(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
