...
{
    public partial class LiabilityCategoryDocumentLinks
    {
        internal static LiabilityCategoryDocumentLinks DeserializeLiabilityCategoryDocumentLinks(JsonElement element)
        {
            ...
            return new LiabilityCategoryDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
