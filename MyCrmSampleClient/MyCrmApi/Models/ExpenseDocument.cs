...
namespace MyCrmSampleClient.MyCrmApi.Models
{
    ...
    public partial class ExpenseDocument
    {
        ...
        internal ExpenseDocument(IReadOnlyDictionary<string, object> meta, IReadOnlyDictionary<string, object> jsonApi, ExpenseDocumentLinks links, Expense data, IReadOnlyList<IncludedResource> included)
        {
            Meta = meta;
            JsonApi = jsonApi;
            Links = links;
        ...
        public ExpenseDocumentLinks Links { get; }
        /// <summary> Gets the data. </summary>
        public Expense Data { get; }
