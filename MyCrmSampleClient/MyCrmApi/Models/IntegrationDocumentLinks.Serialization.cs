...
{
    public partial class IntegrationDocumentLinks
    {
        internal static IntegrationDocumentLinks DeserializeIntegrationDocumentLinks(JsonElement element)
        {
            ...
            return new IntegrationDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
