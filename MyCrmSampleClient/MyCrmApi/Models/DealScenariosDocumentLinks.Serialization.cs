...
{
    public partial class DealScenariosDocumentLinks
    {
        internal static DealScenariosDocumentLinks DeserializeDealScenariosDocumentLinks(JsonElement element)
        {
            ...
            return new DealScenariosDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
