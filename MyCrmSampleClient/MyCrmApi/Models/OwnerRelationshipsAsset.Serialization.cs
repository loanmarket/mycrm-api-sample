...
{
    public partial class OwnerRelationshipsAsset : IUtf8JsonSerializable
    {
        ...
        internal static OwnerRelationshipsAsset DeserializeOwnerRelationshipsAsset(JsonElement element)
        {
            ...
            return new OwnerRelationshipsAsset(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
