...
{
    public partial class ReferrerMemberRelationshipsContactGroups : IUtf8JsonSerializable
    {
        ...
        internal static ReferrerMemberRelationshipsContactGroups DeserializeReferrerMemberRelationshipsContactGroups(JsonElement element)
        {
            ...
            return new ReferrerMemberRelationshipsContactGroups(links.Value, Optional.ToDictionary(meta), data);
        }
    }
}
