...
{
    public partial class IncomeCategoryDocumentLinks
    {
        internal static IncomeCategoryDocumentLinks DeserializeIncomeCategoryDocumentLinks(JsonElement element)
        {
            ...
            return new IncomeCategoryDocumentLinks(self.Value, related.Value, describedBy.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
