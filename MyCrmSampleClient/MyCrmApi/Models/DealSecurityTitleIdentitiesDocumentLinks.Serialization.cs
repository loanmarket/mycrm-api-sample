...
{
    public partial class DealSecurityTitleIdentitiesDocumentLinks
    {
        internal static DealSecurityTitleIdentitiesDocumentLinks DeserializeDealSecurityTitleIdentitiesDocumentLinks(JsonElement element)
        {
            ...
            return new DealSecurityTitleIdentitiesDocumentLinks(self.Value, related.Value, describedby.Value, first.Value, last.Value, prev.Value, next.Value);
        }
    }
}
