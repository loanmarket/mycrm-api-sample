...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class IncomeCategoriesClient
    {
        ...
        public IncomeCategoriesClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetIncomeCategoryAsync(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeCategoriesClient.GetIncomeCategory");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetIncomeCategoryRequest(filter, sort, page, include, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetIncomeCategory(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("IncomeCategoriesClient.GetIncomeCategory");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetIncomeCategoryRequest(IEnumerable<string> filter, IEnumerable<string> sort, object page, IEnumerable<string> include, RequestContext context)
        {
