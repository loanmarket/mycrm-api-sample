...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class AssetsClient
    {
        ...
        public AssetsClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetAssetAsync(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("AssetsClient.GetAsset");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetAssetRequest(filter, sort, page, include, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetAsset(IEnumerable<string> filter = null, IEnumerable<string> sort = null, object page = null, IEnumerable<string> include = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("AssetsClient.GetAsset");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetAssetRequest(IEnumerable<string> filter, IEnumerable<string> sort, object page, IEnumerable<string> include, RequestContext context)
        {
