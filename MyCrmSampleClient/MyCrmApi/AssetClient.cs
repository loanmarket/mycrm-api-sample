...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class AssetClient
    {
        ...
        public AssetClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetAssetAsync(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("AssetClient.GetAsset");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetAssetRequest(id, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetAsset(int id, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("AssetClient.GetAsset");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetAssetRequest(int id, RequestContext context)
        {
