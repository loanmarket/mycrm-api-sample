...
{
    internal partial class AssetRelatedRestClient
    {
        ...
        /// <summary> Initializes a new instance of AssetRelatedRestClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="clientDiagnostics"/> or <paramref name="pipeline"/> is null. </exception>
        public AssetRelatedRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null)
        {
        ...
        public async Task<Response<FinancialAddressesDocument>> GetFinancialAddressesAsync(int id, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        FinancialAddressesDocument value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = FinancialAddressesDocument.DeserializeFinancialAddressesDocument(document.RootElement);
        ...
        /// <param name="id"> The Integer to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<FinancialAddressesDocument> GetFinancialAddresses(int id, CancellationToken cancellationToken = default)
        {
            using var message = CreateGetFinancialAddressesRequest(id);
