...
namespace MyCrmSampleClient.MyCrmApi
{
    ...
    public partial class AssetCategoryRelationshipClient
    {
        ...
        public AssetCategoryRelationshipClient(Uri endpoint = null, MyCRMAPIClientOptions options = null)
        {
            endpoint ??= new Uri("");
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetAssetCategoryRelationshipAsync(int id, string relationshipName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(relationshipName, nameof(relationshipName));

            using var scope = ClientDiagnostics.CreateScope("AssetCategoryRelationshipClient.GetAssetCategoryRelationship");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetAssetCategoryRelationshipRequest(id, relationshipName, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetAssetCategoryRelationship(int id, string relationshipName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(relationshipName, nameof(relationshipName));
        ...
        internal HttpMessage CreateGetAssetCategoryRelationshipRequest(int id, string relationshipName, RequestContext context)
        {
