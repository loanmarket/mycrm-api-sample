...
using System;
namespace MyCrmSampleClient.Kiota.Jsonapi.DealSecurities.Item.Asset
{
    /// <summary>
    /// Builds and executes requests for operations under \jsonapi\deal-securities\{id}\asset
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class AssetRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::MyCrmSampleClient.Kiota.Jsonapi.DealSecurities.Item.Asset.AssetRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/jsonapi/deal-securities/{id}/asset", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::MyCrmSampleClient.Kiota.Jsonapi.DealSecurities.Item.Asset.AssetRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/jsonapi/deal-securities/{id}/asset", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MyCrmSampleClient.Kiota.Jsonapi.DealSecurities.Item.Asset.AssetRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::MyCrmSampleClient.Kiota.Jsonapi.DealSecurities.Item.Asset.AssetRequestBuilder WithUrl(string rawUrl)
        {
            return new global::MyCrmSampleClient.Kiota.Jsonapi.DealSecurities.Item.Asset.AssetRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
